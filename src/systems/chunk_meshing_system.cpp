...
inline void ChunkMeshingSystem::fillBlockSide(
    ...
    auto vertice1 = blockObject.vertices[0 + vertexOffset];
    auto vertice2 = blockObject.vertices[1 + vertexOffset];
    auto vertice3 = blockObject.vertices[2 + vertexOffset];
    auto vertice4 = blockObject.vertices[3 + vertexOffset];
    ...
    chunkModel.vertices.emplace_back(std::move(vertice1));
    chunkModel.vertices.emplace_back(std::move(vertice2));
    chunkModel.vertices.emplace_back(std::move(vertice3));
    chunkModel.vertices.emplace_back(std::move(vertice4));
}
